...
ActiveRecord::Schema.define(version: 2026_03_29_143852) do
  ...
  create_table "site_sections", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_site_sections_on_user_id"
  end
  ...
  create_table "tasks", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "site_section_id", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["site_section_id"], name: "index_tasks_on_site_section_id"
  ...
  add_foreign_key "tasks", "site_sections"
